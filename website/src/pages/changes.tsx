...
import ledgerDocument from '../../static/changes.json';
...
const surfaces = new Map<string, DocumentationSurface>(
    ...
    <Layout
      ...
      <main className="container">
        <header className={styles.hero}>
          ...
          <p>
            Every public release appears here automatically. Maintainers enrich the changes that
            alter an adopter journey, migration, or relationship; the owning repository remains
            the authority and links to its evidence.
          </p>
          <div className={styles.feedLinks}>
            <a href="/getting-started/changes/rss.xml">RSS</a>
            <a href="/getting-started/changes/feed.json">JSON Feed</a>
          </div>
